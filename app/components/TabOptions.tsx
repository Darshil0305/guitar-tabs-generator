      ...
      <div className="mt-6 pt-4 border-t border-gray-200">
        ...
        <div className="flex items-center">
          ...
          <div className="ml-2 group relative">
            ...
            <div className="opacity-0 group-hover:opacity-100 transition-opacity absolute z-10 w-72 p-2 bg-gray-800 text-white text-xs rounded shadow-lg -left-2 bottom-full mb-1">
              Source separation uses AI to isolate the guitar track from other instruments and vocals, 
              leading to more accurate tab generation. Note that this feature may not be available on all servers 
              or may fall back to standard processing if dependencies are missing. When available, it may take 
              longer to process.
            </div>
          </div>
        </div>
